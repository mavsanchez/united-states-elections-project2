...
const geoData = "https://raw.githubusercontent.com/mavsanchez/united-states-elections-project2/master/static/data/mydata.json"; //For production
...
function updateMap(event){
    let selected_year = d3.event.target.value || 1976;
      ...
      d3.json(geoData, function (response) {
        ...
        geojsonLayer = L.choropleth(response, {
          ...
          style: function (feature) {
            switch (feature.properties.winner1) {
              case "red":
                return {
                  fillColor: "#800000",
